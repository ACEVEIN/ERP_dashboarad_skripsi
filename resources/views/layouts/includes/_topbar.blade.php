...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <span class="mr-2 d-none d-lg-inline text-gray-600 small">Saitama Sensei</span>
            <img class="img-profile rounded-circle"
                src="{{ asset('assets/img/undraw_profile.svg') }}">
        </a>
        <!-- Dropdown - User Information -->
        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
            aria-labelledby="userDropdown" style="width: 325px !important">

            <div class="d-flex align-items-center ml-2">
                <img class="img-profile rounded-circle m-1" style="width: 65px" src="{{ asset('assets/img/undraw_profile.svg') }}">
                <div class="col ml-2">
                    <h5 class="m-0 p-0">Saitama Sensei</h5>    
                    <div style="small">God of Human</div>    
                </div>
            </div>
